---
name: kvdwerf-meubels-style
description: Use when building any web UI in the visual style of the Pinterest board 'kvdwerf-meubels'. Applies the bundled design tokens (colors, typography, radius, spacing, shadow) and the board imagery as immersive elements. Vibe: minimalist, mid-century, sculptural, scandinavian, material-honest.
---

# kvdwerf-meubels — Style-Skill
